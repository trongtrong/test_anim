...
class _OpenChestScreenState extends State<OpenChestScreen> with TickerProviderStateMixin {
  @override
  ...
  // }
  //
  // final List<String> _tipMarqueeList = [];
  //
  // _initMarquee() {
  ...
  //         // List<Text>, textList and textSpanList can only have one of code.
  //         fontSize: 14.0,
  //         // text size
